...
const ProfileSettings = () => {
  ...
  <input type="text" name="name" placeholder="Enter Name" required className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-orange-500 focus:outline-none" />
</div>
<div className="space-y-2">
