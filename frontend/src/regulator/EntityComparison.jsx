...
const EntityComparison = () => {
  ...
  const mockData = Array(5).fill(0).map((_,i) => ({id: 'Sample ' + i, entity: 'Sample ' + i, status: 'Sample ' + i, score: 'Sample ' + i, lastAudit: 'Sample ' + i}));
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-2xl font-bold text-slate-800">Entity Comparison</h2>
