  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-2xl font-bold text-slate-800">Upload Inspection Report</h2>
...
<div className="space-y-2">
  ...
  <input type="text" name="category" placeholder="Enter Category" required className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-red-500 focus:outline-none" />
</div>
