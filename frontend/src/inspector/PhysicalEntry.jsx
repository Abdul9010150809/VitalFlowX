...
const PhysicalEntry = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-2xl font-bold text-slate-800">Physical Inspection Entry</h2>
  ...
  <label className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Zone</label>
  <input type="text" name="zone" placeholder="Enter Zone" required className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-red-500 focus:outline-none" />
</div>
<div className="space-y-2">
  <label className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Notes</label>
  <input type="text" name="notes" placeholder="Enter Notes" required className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-red-500 focus:outline-none" />
</div>
